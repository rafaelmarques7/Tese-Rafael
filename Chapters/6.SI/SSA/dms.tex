\todo{Vou retirar todas as referencias ao web scraping daqui, e referir apenas comunicao via API.}
\todo{Apos retirar o webscraping, este subcapitulo devera ficar bem mais sucinto e claro.}
