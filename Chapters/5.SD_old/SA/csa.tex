\todo{Thats not the goal of the CSA. The goal is to be a flight search engine. }
\todo{The CSA is designed to serve as I/O}
...
\todo{This entire paragraph must be replaced. The new must be pragmatic and objective. Just this, Goal: adjust the design of the webpage according to the device rendering it. }
\todo{Remove adjectives like interesting. If you want to adjectify, argument why it is important (and not interesting!) to have that.}
