...
Applying constrains (1-4) to the proposed FTP leads to the time-dependent Traveling Salesman Problem \todo{Add reference}, as defined in section \ref{sec:TDTSP_ILP}.
